...
public class UniversTest {
    ...
    public void testStructure() {
        ...
        assertEquals(true, isInstanceHere,"Champs instance absent");
        assertEquals(true, isListeClesPubliquesHere,"Champs listeClesPubliques absent");
        assertEquals(true, isListeMessagesPublicsHere,"Champs listeMessagesPublics absent");
    }

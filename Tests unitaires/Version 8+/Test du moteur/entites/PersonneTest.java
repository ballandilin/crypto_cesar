...
public class PersonneTest {
    ...
    public void testStructure() {
        ...
        assertEquals("Champs nom absent",true, isNomHere);
        assertEquals("Champs algorithme absent",true, isAlgorithmeHere);
        assertEquals("Champs clesPrivees absent",true, isClesPriveesHere);
    }
